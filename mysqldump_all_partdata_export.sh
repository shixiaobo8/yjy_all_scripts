...
db_user=root
conn=_
db_password=abcxxx123
all_dbs=(dev_letiku examapi examapp hlzyys kqzh letiku letiku.net percona recite user_answer_sub user_note_sub xiyizonghe xyzyys yiyao yjy_central yjy_justice yjy_nursing yjy_pharmic yjy_ucenter zyys zyzh zyzyys)
